                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mx-auto" style="max-width: 700px;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary d-flex justify-content-center">Edit Admin
                            </h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.update', $admin->id) }}" >
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control bg-light border-1 small" name="nama" 
                                        placeholder="Masukkan Nama" aria-label="Search" aria-describedby="basic-addon2" value="{{ $admin->nama }}">
                                </div>
                                <label class="form-label" for="form3Example3">Email</label>
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control bg-light border-1 small" name="email"
                                        placeholder="Masukkan Email" aria-label="Search" aria-describedby="basic-addon2" value="{{ $admin->email }}">
                                </div>
                                <label class="form-label" for="form3Example3">Password</label>
                                <div class="input-group mb-3">
                                    <input type="password" class="form-control bg-light border-1 small" name="password"
                                        placeholder="Masukkan Password" aria-label="Search" aria-describedby="basic-addon2" value="{{ $admin->password }}">
                                </div>
                                ...
                                <div class="input-group mb-5">
                                    <input type="text" class="form-control bg-light border-1 small" name="no_telp"
                                        placeholder="Masukkan No Telp" aria-label="Search" aria-describedby="basic-addon2" value="{{ $admin->no_telp }}">
                                </div>
